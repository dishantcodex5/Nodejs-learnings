...
// // utf-8 (short for "8-bit Unicode Transformation Format") Encodes
// characters from nearly all written languages, symbols, and emojis.
const fileName="test.txt";
const filepath=path.join(__dirname,fileName);
console.log(__dirname);
const writeFile=fs.writeFileSync(
    filepath,
    "this is the intial data,updated",
    "utf-8"
);
...
// example, if you need both raw binary data and its string
// representation.
...
const newpath=path.join(__dirname,updatedFileName);
